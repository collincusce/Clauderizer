...
> **This file has moved to `docs/clauderizer/DECISIONS.md`.**
>
...
### D-900000 — SENTINEL: do not write below this line

An install too old to know about `docs/clauderizer/` will resolve *this* file
when it records a DECISIONS entry, and append here. This deliberately-high id
exists so such a write cannot collide with a real one — anything numbered above
`D-900000` in this file is an orphan that belongs in the real register.
