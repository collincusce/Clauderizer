...
|-------|------|--------|---------|-----------|---------|
| 0 | Confirm the daimon runtime contract + design cross-platform detection | ⬜ READY | — | — | handoffs/PHASE-0-HANDOFF.md |
| 1 | Bespoke kimi-desktop detection + auto-write emitter | ⬜ NOT STARTED | — | — | handoffs/PHASE-1-HANDOFF.md |
