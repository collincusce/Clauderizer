...
|-------|------|--------|---------|-----------|---------|
| 0 | Design the cz_audit work/release self-audit gate | ⬜ READY | — | — | handoffs/PHASE-0-HANDOFF.md |
| 1 | Implement rituals/audit.py + register cz_audit | ⬜ NOT STARTED | — | — | handoffs/PHASE-1-HANDOFF.md |
